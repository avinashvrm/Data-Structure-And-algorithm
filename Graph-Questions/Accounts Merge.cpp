//DFS approch - building a graph for all the emails and storing name separtly.
//            - In dfs call we are fetching the set of equvalent email address and we combine it with name and store in res.
class Solution {
private:
